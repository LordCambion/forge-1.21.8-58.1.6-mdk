package net.lordcambion.mod3rnmod.init;
...
public class ModEntityTypes {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(Registries.ENTITY_TYPE, Mod3rnMod.MOD_ID);
            ...
            ENTITY_TYPES.register("ender_arrow",
                    () -> EntityType.Builder.<EnderArrowEntity>of(EnderArrowEntity::new, MobCategory.MISC)
                            ...
                            .build(ResourceKey.create(Registries.ENTITY_TYPE,
                                    ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID, "ender_arrow"))));
