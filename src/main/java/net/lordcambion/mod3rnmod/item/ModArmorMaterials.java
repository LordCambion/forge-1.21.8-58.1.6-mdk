...
public class ModArmorMaterials {
    ...
    private static final ResourceKey<? extends Registry<EquipmentAsset>> EQUIPMENT_ASSET_REGISTRY =
            ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID, "equipment_asset"));
    ...
    private static TagKey<Item> createRepairTag(String tagName) {
        return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID, tagName));
    }
    ...
    private static ResourceKey<EquipmentAsset> createAssetKey(String materialName) {
        ...
        return ResourceKey.create(
                ...
                ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID, materialName)
        );
    }
