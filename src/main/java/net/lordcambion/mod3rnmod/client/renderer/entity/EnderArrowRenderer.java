package net.lordcambion.mod3rnmod.client.renderer.entity;
...
public class EnderArrowRenderer extends ArrowRenderer<EnderArrowEntity, ArrowRenderState> {
    ...
    public static final ResourceLocation ENDER_ARROW_LOCATION =
            ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID, "textures/entity/projectiles/ender_arrow.png");
