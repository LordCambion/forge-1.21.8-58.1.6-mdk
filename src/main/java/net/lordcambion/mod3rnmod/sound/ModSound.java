package net.lordcambion.mod3rnmod.sound;
...
public class ModSound {
    ...
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS=
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Mod3rnMod.MOD_ID);
    ...
    public static final RegistryObject<SoundEvent> PANICDOX =registerSoundEvent("panicdox");
        public static final ResourceKey<JukeboxSong> PANICDOX_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
                ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID,"panicdox"));
        ...
        public static final ResourceKey<JukeboxSong> CRYSIS_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
                ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID,"crysis"));
        ...
        public static final ResourceKey<JukeboxSong> DYNAMITE_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
                ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID,"dynamite"));
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String name){
        return  SOUND_EVENTS.register(name,
                () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Mod3rnMod.MOD_ID,name)));
    }
